...
class SSD1331(object):
    ...
    def Init(self):
        ...
        self.command(SET_PRECHARGE_SPEED_A)
        self.command(0x64)  # 100
        # Set Second Pre-change Speed For ColorB
        self.command(SET_PRECHARGE_SPEED_B)
        self.command(0x78)  # 120
        # Set Second Pre-change Speed For ColorC
        self.command(SET_PRECHARGE_SPEED_C)
        self.command(0x64)  # 100
        ...
        self.command(PHASE_PERIOD_ADJUSTMENT)
        self.command(0x31)  # 0x31
        # display clock divider/oscillator frequency
        self.command(DISPLAY_CLOCK_DIV)
        self.command(0xF0)
